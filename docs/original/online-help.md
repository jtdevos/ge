...
## `help planets (screen 2)` — HLPPLAN2
...
## `help planets (screen 3)` — HLPPLAN3
...
## `help hyper (hyper-phasers)` — HLPHYP
...
## `help class (table header)` — HLPCLS1
...
## `help class (table footer/legend)` — HLPCLS2
...
## `help class nn (bad class number)` — HLPCLS3
